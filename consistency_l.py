...
total_len = len(bank_mass1)
start_index = int(50*args.batch_num)
end_index = start_index + 50
if (end_index > total_len):
    end_index = total_len

bank_mass1 = bank_mass1[start_index:end_index]
bank_mass2 = f_bank['mass2'][start_index:end_index]
bank_ecc = f_bank['eccentricity'][start_index:end_index]
bank_lan = f_bank['long_asc_nodes'][start_index:end_index]
bank_inc = f_bank['inclination'][start_index:end_index]

bank_apx = f_bank['approximant'][start_index:end_index]
